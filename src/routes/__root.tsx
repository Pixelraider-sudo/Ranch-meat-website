...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { title: "Ranch Meat — Traceable Farm-to-Table Meat Marketplace" },
        {
          name: "description",
          content:
            "Buy verified, cold-chain traced meat direct from audited ranches. Built for households, restaurants and wholesale buyers.",
        },
        { name: "author", content: "Ranch Meat" },
        {
          property: "og:title",
          content: "Ranch Meat — Traceable Farm-to-Table Marketplace",
        },
        {
          property: "og:description",
          content:
            "Verified ranches, sensor-backed cold chain, next-day chilled delivery.",
        },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:site", content: "@ranchmeat" },
      ],
      links: [
        {
          rel: "stylesheet",
